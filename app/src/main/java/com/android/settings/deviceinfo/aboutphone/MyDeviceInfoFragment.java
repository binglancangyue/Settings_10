            ...
            if (TelephonyIntents.ACTION_RADIO_STATE_CHANGED.equals(action)) {
                ...
                if (Utils.mRadioAvailable) {
                    if (findPreference(KEY_SIM_STATUS) == null)
                       getPreferenceScreen().addPreference(mSimstatus);
                    if (findPreference(KEY_IMEI_INFO) == null)
                       getPreferenceScreen().addPreference(mImeiinfo);
                } else {
                    if (findPreference(KEY_SIM_STATUS) != null)
                       getPreferenceScreen().removePreference(mSimstatus);
                    if (findPreference(KEY_IMEI_INFO) != null)
                       getPreferenceScreen().removePreference(mImeiinfo);
                }
            }
        }
    };
